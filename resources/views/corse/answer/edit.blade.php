        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="card-title mb-0">Edit Answer</h4>
                ...
                <form method="POST" action="{{ route('admin.answers.update', $answer->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="question_id" id="question_id" class="form-select form-select-lg" required>
                    ...
                    <div class="form-group">
                        ...
                        <select name="is_correct" id="is_correct" class="form-select form-select-lg" required>
                            <option value="0" {{ old('is_correct', $answer->is_correct) == '0' ? 'selected' : '' }}>No — Wrong Answer</option>
                            <option value="1" {{ old('is_correct', $answer->is_correct) == '1' ? 'selected' : '' }}>Yes — Correct Answer</option>
                        </select>
                    </div>

                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary btn-lg me-2">Update Answer</button>
