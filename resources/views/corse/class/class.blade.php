            ...
            <form method="POST" action="{{ route('admin.classes.store-question') }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="class_modal_reason" class="form-label fw-bold">Reason / Explanation <small class="text-muted">(Optional)</small></label>
                        <textarea name="reason" id="class_modal_reason" rows="2" class="form-control" placeholder="Enter explanation or reason for the correct answer..."></textarea>
                    </div>
